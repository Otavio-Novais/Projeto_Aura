...
class Topico(models.Model):
    ...
    tecnica_estudo = models.ForeignKey(TecnicaEstudo, on_delete=models.CASCADE, related_name='topicos')
...
class Avaliacao(models.Model):
    nome = models.CharField(max_length=150)
    materia = models.ForeignKey(Materia, on_delete=models.CASCADE, related_name='avaliacoes')
    data_entrada = models.DateField(auto_now_add=True)
...
class Lembrete(models.Model):
    ...
    avaliacao = models.ForeignKey(Avaliacao, on_delete=models.CASCADE, related_name='lembretes')
